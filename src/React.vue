    ...
    <svg width="20em" height="20em" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 550 550" xml:space="preserve">
        <svg:style type="text/css">
            .react-icon-st0{fill:#00D8FF;}
        </svg:style>
        <path class="react-icon-st0" d="M274.7,383.1c-66.4,0-124.3-7.8-167.7-22.7c-28.1-9.6-52-22.4-69.1-37c-18.1-15.4-27.7-32.3-27.7-48.6
        ...
        <path class="react-icon-st0" d="M167.5,510.3c-9.6,0-18.1-2.1-25.2-6.2c-27-15.6-36.4-60.6-25-120.4c9.3-49,32.1-106.6,64.2-162.3
            ...
            L191.2,227.1z"/>
        <path class="react-icon-st0" d="M381.9,510.6c-25.6,0-58.1-15.4-91.9-44.6c-37.8-32.6-76.3-81-108.5-136.7l0,0c-31.6-54.6-54.2-111.3-63.7-160
        ...
        <circle class="react-icon-st0" cx="274.6" cy="275.3" r="47"/>
        <text x="20" y="35" >{{msg}}</text>
    </svg>
</template>
...
export default {
  data () {
        console.log(document.getElementsByClassName('react-icon-st0'))
